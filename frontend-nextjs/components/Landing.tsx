...
const Landing = () => {
  ...
  return (
    <Card className="m-auto mt-10 w-[700px] bg-[#151313]">
      <CardHeader className="flex flex-row items-center justify-between w-full">
        <div className="flex flex-col w-full p-8">
          <CardTitle className="text-2xl font-medium flex flex-col gap-6">
            <div className="flex flex-col">
              <span>Sign in for all features like</span>
              <span className="text-lg text-[#8c8181]">• Persitent Logs</span>
              <span className="text-lg text-[#8c8181]">
            ...
            <div className="flex gap-8 mt-10">
              ...
              <Button
                onClick={() => router.push("/projects/guest")}
                className="w-full"
              >
                Deploy as guest
              </Button>
